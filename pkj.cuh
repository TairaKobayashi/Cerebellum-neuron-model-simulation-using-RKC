...
#define V_K_PKJ      ( -85.0 )
#define V_EX_PKJ     ( 0.0)
#define G_GJ_PKJ    ( 2.5e-6 ) //( 2.5e-6 ) // Gap Junctional Conductance [mS]
...
#define PKJ_S_G_CaT   (0.5)
#define PKJ_S_G_KH    (0.3)
#define PKJ_S_G_KDR   600.0
#define PKJ_S_G_KM    0.040
...
#define PKJ_MD_G_CaP  (4.5)
#define PKJ_MD_G_CaT  (0.5)
#define PKJ_MD_G_KH   (0.0)
#define PKJ_MD_G_KDR  60.0
#define PKJ_MD_G_KM   0.01
#define PKJ_MD_G_KA   (2.0)
#define PKJ_MD_G_KC   (80.0)
#define PKJ_MD_G_K2   (0.39)

// Rest of Dendrite
#define PKJ_RD_G_NaF  (0.0)
#define PKJ_RD_G_NaP  (0.0)
#define PKJ_RD_G_CaP  (4.5)
#define PKJ_RD_G_CaT  (0.5)
#define PKJ_RD_G_KH   (0.0)
#define PKJ_RD_G_KDR  (0.0)
#define PKJ_RD_G_KM   0.013//0.1//
#define PKJ_RD_G_KA   (0.0)
#define PKJ_RD_G_KC   (80.0)
...
__global__ void pkj_set_current ( neuron_t *, const double );
